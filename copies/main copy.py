...
def load_images():
    ...
    for e in p_names:
        IMAGES[e] = p.transform.scale(
            p.image.load("./img/" + e + ".png"), (SQ_EACH_SIZE, SQ_EACH_SIZE)
        )
    ...
    while running:
        for e in p.event.get():
            if e.type == p.QUIT:
                ...
                if (
                ...
                ):  # make sure that the dragged is not empty and within bounds
                    ...
                    if (
                        ...
                        if (
                            ...
                            if (
                                gs.board[mpy][mpx][1] == "K"
                                and gs.board[my][mx][1] == "R"
                            ):
